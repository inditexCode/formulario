...
const validarCampo = (expresion, input, campo) =>{
    const inputText = input.value.trim(); // Usar 'input' en lugar de 'e.target.value'

    if (inputText === '') {
        // Si el input está vacío, asegúrate de que no se muestre ningún mensaje de error ni de éxito
...
const validarpassword = () =>{
    ...
    const password2Text = password2.value.trim();

    if (password2Text === '') {
        // Si el input password2 está vacío, asegúrate de que no se muestre ningún mensaje de error ni de éxito
